...
yay -Syu --noconfirm polybar arandr pulseaudio pavucontrol spotify nextcloud-client go-task pre-commit sioyek nvidia-settings libwacom xf86-input-wacom xournalpp biber xclip borgmatic python-llfuse flameshot lazygit ranger bitwarden bitwarden-cli
