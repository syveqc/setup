...
hl.animation({ leaf = "windows", enabled = true, speed = 0.1, spring = "easy" })
...
-- See https://wiki.hypr.land/Configuring/Advanced-and-Cool/Devices/ for moretruetruetrue
hl.device({
    name = "epic-mouse-v1",
    sensitivity = -0.5,
})
...
hl.bind(mainMod .. " + A", hl.dsp.exec_cmd("notify-send 'hi'"))
local closeWindowBind = hl.bind(mainMod .. " + Q", hl.dsp.window.close())
-- closeWindowBind:set_enabled(false)
-- Power menu submap (SUPER+SHIFT+E): [l]ock | [e]xit | [s]hutdown | [r]eboot
hl.bind(mainMod .. " + SHIFT + E", hl.dsp.submap("power"))
